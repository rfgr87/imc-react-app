      ...
      <div className={classNames(classes.main, classes.mainRaised)}>
        <div>
            ...
            <div className={classes.description}>
              ...
              {"Tiene un Bachillerato en Música de Berklee College of Music y estudios de música por computadora y composición en el Instituto de Sonología en La Haya, Paises Bajos donde estudió con Paul Berg y Richard Barrett. A estudiado en Musiques et Recherches, Bélgica con Benjamin Thigpen y a tomado clases magistrales con Christian Wolff y Barry Truax."}<br></br><br></br>
