...
function Medios() {
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    ...
    <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1102350589&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style={{fontSize: "10px", color: "#cccccc", lineBreak: "anywhere", wordBreak: "normal", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis", fontFamily: "Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif", fontWeight: "100"}} ><a href="https://soundcloud.com/user-747382031" title="IMC" target="_blank" sstyle={{color: "#cccccc", textDecoration: "none"}}>IMC</a> · <a href="https://soundcloud.com/user-747382031/puredata-clase-13-patch-1-un-poco-de-noize" title="PureData - Clase 13 - Patch 1 - Un poco de Noize" target="_blank" style={{color: "#cccccc", textDecoration: "none"}}>PureData - Clase 13 - Patch 1 - Un poco de Noize</a></div>
   </div>
